    ...
    Card(
        ...
        Column(
            modifier = Modifier.padding(
                all = dimensionResource(R.dimen._4dp)
            ),
...
internal fun OutputCard(
    ...
    Card(
        ...
        elevation = CardDefaults.cardElevation(
            defaultElevation = dimensionResource(R.dimen._4dp)
        )
    ) {
        Column(
            modifier = Modifier.padding(
            ...
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .alpha(if (hasText) 1f else 0f),
                horizontalArrangement = Arrangement.spacedBy(dimensionResource(R.dimen._12dp), Alignment.End),
